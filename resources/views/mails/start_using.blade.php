...
<tr>
	...
	<span style="font-family:Trebuchet MS, Verdana, Arial; font-size:17px; font-weight:bold;">Set up a new password!</span>
	<br />
	<p>Your account was successfully created, you can click the following link to start using your account:</p>

	<p>Please click <a href="[YOUR WEBSITE ADDRESS]">return to my website</a> to start using your account.</p>
